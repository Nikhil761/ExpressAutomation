...
public class FixedDayFullAmount extends TestBase{
	LoginPage loginPage;
	AccountsPage accountsPage;
	AutoPayPage autoPayPage;
	
	public FixedDayFullAmount() {
		super();
	}
	...
	@Test(priority=1)
	public void FixdayFullAmountAutoPay() throws Exception {
		loginXBPV2();
		...
		if(autoPayPage.editOrSetUpAutoPay()==true) {
			autoPayPage.editAutopayToSetFixedDayFullAmount();
		}
		else if(autoPayPage.editOrSetUpAutoPay()==false) {		
		
			autoPayPage.setUpAutoPayToSetFixedDayFullAmount();
		}
